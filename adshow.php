    ...
    <body>
        ...
        <header>
            ...
            <nav class="navigation">
                ...
                <a href="adcard.php" class="active">Advertisements</a>
            ...
            <div class="container px-5 px-lg-2 my-5">
                <div class="row gx-2 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6 infocard">
                        ...
                        <div class="fs-6 mb-5">
                            <span></i><?php echo "Place: ".$row['pplace'] ?></span>
                        </div>
                        <div class="infocard">
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy;  Agrosphere 2023</p></div>
        </footer>
        <!-- Bootstrap core JS-->
